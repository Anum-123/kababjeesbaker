...
.background-image {
   ...
   text-align: center;
   padding: 20rem 0; /* Adjust padding as needed */
}
.container {
   width: 100%;
   margin: 0 auto;
...
<section class="products" >
   ...
   <div class="box-container">
      ...
      <form action="" method="post">
         <div class="box">
            <img style="width:280px;" src="uploaded_img/<?php echo $fetch_product['image']; ?>" alt="">
...
<?php
    if (isset($_POST['save_btn'])) {
        ...
        $query = "INSERT INTO selected_areas (secondService) VALUES ('$selectedArea')";
