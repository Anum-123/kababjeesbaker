...
if(isset($_POST['order_btn'])){
   ...
   $detail_query = mysqli_query($con, "INSERT INTO `order`(name, number, method,  city, country, total_products, total_price) VALUES('$name','$number','$method','$city','$country','$total_product','$price_total')") or die('query failed');
   ...
   if ($cart_query && $detail_query) {
       ...
       <div class='message-container'>
          ...
          <div style='display:flex;' class='flexbtn'>
             <a href='products.php' class='btn' style='width: 150px;margin-left:70px;'>continue shopping</a>
             <a href='logout.php' class='btn' style='width: 150px; margin-left: 20px;'>Log Out</a>
