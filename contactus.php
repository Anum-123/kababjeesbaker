...
<body>
  ...
  <div class="middlenav">
    ...
    <nav>
      <a style="margin-left: 20px;" href="http://localhost/anumprogram/web/landingpage.php">HOME</a>
      <a style="margin-left: 15px;"  href="http://localhost/anumprogram/web/aboutus.html">ABOUT
        US</a>
      <a style="margin-left: 15px;" href="http://localhost/anumprogram/web/bankoffer.html">BANK
        OFFERS</a>
      <a style="margin-left: 15px;" href="http://localhost/anumprogram/web/ourlocatioon.html">OUR
        LOCATION</a>
      <a style="margin-left: 15px;" class="active" href="http://localhost/anumprogram/web/contactus.php">CONTACT
        US</a>
    </nav>
        <!-- <button><a
                href="file:///C:/xampp/htdocs/anumprogram/crud%20operation/crud%20operation/MERN%20Project/modal.html">ORDER
                NOW</a></button> -->
  </div>
  <div class="feedback">

    <p style="font-size: 50px; text-align: center; color: white;
              font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif">Contact Us</p>
    <p style="font-size: 25px; text-align: center; color: white;
                font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif">
      Please kindly email us for any inquiry after operations hours</p>
  ...
  <div class="bottom-container1">
    <div class="bottom1">
      ...
      <p style=" color: white; margin-left: 40px;margin-top: 5px; ">Send Us a Message </p>
      <form action="" method="POST" onsubmit="return validateForm()" name="contactForm">
        <input style="margin-top: 30px;" name="firstname" type="text" placeholder="Name" required class="input-field" /><br><br>
       
        <input type="tel" name="number"  placeholder="Number" pattern="[0-9]{12,13}" title="Please enter a valid phone number (12-13 digits)" required class="input-field" /><br><br>
       
        <input type="email" placeholder="Email" name="email"  required class="input-field" /><br><br>
       
        <input style="margin-left: 9px;" type="text" name="subject" placeholder="Subject" required class="input-field" /><br><br>
       
        <textarea style="margin-left: 9px;" rows="6" cols="55" name="description"  placeholder="Message"></textarea>
        
        <input style="background-color: red; color: white; width: 40%; 
            height: 30px; margin-left: 10px;margin-top: 30px; border: 2px red;" type="submit" name="save_btn" value="SEND MESSAGE"><br><br>
    </div>
    </form>
    <?php
    if (isset($_POST['save_btn'])) {
        ...
        $query = "INSERT INTO contact (firstname,number,email,subject,description) VALUES('$fname','$lname','$email','$sub','$des')";
