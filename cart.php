...
.shopping-cart {
   background-color: rgba(255, 255, 255, 0.9); /* Add a semi-transparent white background to the shopping cart section */
   padding: 2rem;
   border-radius: 0.5rem;
   box-shadow: var(--box-shadow);
   margin-top: 2rem;
   overflow: hidden; /* Add overflow: hidden to prevent content from overflowing the rounded corners */
}
.shopping-cart table {
   text-align: center;
   width: 100%;
