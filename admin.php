...
.display-product-table table {
   ...
   border-collapse: collapse; /* Add this property to collapse the borders */
...
<form style="background-color: #353333;" action="" method="post" class="add-product-form" enctype="multipart/form-data">
